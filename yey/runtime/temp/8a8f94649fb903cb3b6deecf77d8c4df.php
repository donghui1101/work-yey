<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/income\index.html";i:1552727036;s:78:"E:\PhpStudy\PHPTutorial\WWW\work\yey\application\admin\view\public\layout.html";i:1551152160;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <!--<div id="explanation" class="explanation" style="color: rgb(44, 188, 163); background-color: rgb(237, 251, 248); width: 99%; height: 100%;">-->
        ...
        <!--</ul>-->
    <!--</div>-->
    <div class="flexigrid" style="position: relative;">
        <div class="mark" style="width: 100%;height:100%;background: red;display: none;z-index: 999;position: absolute;"></div>
         <div  id="causebox" style="width:450px;height:300px;background:#2bf666;position: absolute;left:30%;top:45%;z-index:99999;display:none">
               <div style="width:10px;height:20px;float:left"><button type="button" id="closebox">X</button></div><br />
                <div>
                    <form action="" method="post">
                        <span style="font-size:22px;color:black">添加:</span>
                        <input type="text"  name="causename" placeholder="请输入类型" style="width:300px" /><br />
              ...
              <div style="float: right;z-index:99999"><button type="button" id="btn" >添加费用类型</button></div>
        <div class="ayou_div1" style="width:95%;">
            <!--设置选项卡-->
            <div class="ayou_div2">
