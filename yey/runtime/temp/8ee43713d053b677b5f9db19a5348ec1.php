<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/techang\add.html";i:1553495869;s:78:"E:\PhpStudy\PHPTutorial\WWW\work\yey\application\admin\view\public\layout.html";i:1551152160;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default">
            <div class="ncap-form-default">
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <input type="text" name="Incomep" maxlength="18" value="<?php echo $info['password']; ?>" id="inform_type" class="input-txt">
                    ...
                    <dd class="opt">
                        <input type="text" name="spendp" maxlength="18" value="<?php echo $info['password']; ?>" id="d_photo[]" class="input-txt">
                    </dd>
