	...
	<div class="Moving">
		<div class="moving">
			...
			<div class="moving_content">
				...
				<el-form ref="fromline" :model="formObj" label-width="80px" name="uploadData">
						<div class="content">
						<div class="title"><span>标题 :</span><input type="text" v-model="formObj.inform_title"></div>
						<div class="content1">
							<span>内容 :</span>
							<textarea v-model="formObj.inform_desc"></textarea>
						</div>
						<div class="choose">
							<span>图片:</span>
						...
						<div class="choose1">
							...
							<select name="" class="choose2" v-model="formObj.gardent_id">
								<option value="1" v-for="item in JurisdictionList" @change="gardent(item.admin)">{{item.addr_id}}</option>
							</select>
						...
						<div class="btn"><button type="button" @click="uploadData">提交</button></div>
					</div>
				</el-form>
			</div>
		</div>
	...
	export default{
	    ...
	    methods:{
	      handleRemove(file, fileList){
	        console.log(file, fileList,66678777);
	      },
        ...
        console.log(file,11111);
	      ...
	      uploadData(){
	      	...
	      	axios.post("api/index.php/api/Notic/addDynamic",{
	      		admin_id: cookieId,
